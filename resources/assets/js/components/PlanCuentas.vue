                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarPlanCuentas(1,buscar,criterio)" class="form-control mx-2" placeholder="Texto a buscar">                                    
                                    <select class="form-control col-md-2 mx-2" v-model="anio">
                                    ...
                                    <button type="submit" @click="listarPlanCuentas(1,buscar,criterio)" class="mx-2 btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods : {
            listarPlanCuentas (page,buscar,criterio){
                let me=this;
                var url= this.ruta +'/planCuentas?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio + '&anio=' + this.anio;
