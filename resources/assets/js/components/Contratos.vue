                        ...
                        <div class="form-group row">
                            ...
                            <tbody>
                                <tr v-for="pago in arrayPagos" :key="pago.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" @click="anularPago(pago.id)">
                                            <i class="icon-trash"></i>
                                        </button>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" v-if="tipoAccionBeneficiario==0">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-inline col-md-11">
                                            <input type="text" readonly class="form-control" style="width: 70%;" :class="{'is-invalid':NoTercero}"  v-model="tercero">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-9 float-right">
                                             <input type="number" v-model="n_contrato" class="form-control float-right"  :class="{'is-invalid':NoContrato}" placeholder="Numero de contrato"> 
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="tel" class="form-control" :class="{'is-invalid':NoTel}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Celular</label>
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="cel" class="form-control" :class="{'is-invalid':NoCel}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Estado</label>
                                        <div class="col-md-9 float-right">
                                            <select v-model="estado" class="form-control":class="{'is-invalid':NoEstado}" >
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-9 float-right">
                                            <input type="date" v-model="fecha_contrato" class="form-control" :class="{'is-invalid':NoFcontra}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-9 float-right">
                                            <input type="time" v-model="hora_contrato" class="form-control" :class="{'is-invalid':NoHcontra}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Barrio</label>
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="barrio" class="form-control" :class="{'is-invalid':NoBarrio}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-inline col-md-9 float-right">
                                            <select v-model="id_ocupacion" class="form-control" :class="{'is-invalid':NoOcupa}" style="width:79%;">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="referencias" class="form-control" :class="{'is-invalid':NoReferencia}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Telefono Referencia</label>
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="tel_referencia" class="form-control" :class="{'is-invalid':NoTelReferencia}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Valor Mensual</label>
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="vr_mensual" class="form-control" :class="{'is-invalid':NoValorMensual}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="vr_semestre" class="form-control" :class="{'is-invalid':NoValorSemestre}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Valor Anual</label>
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="vr_año" class="form-control" :class="{'is-invalid':NoValorAnual}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="col-md-3 form-control-label float-left" for="email-input">Lugar Cedula</label>
                                        <div class="col-md-9 float-right">
                                            <input type="text" v-model="lugar_cedula" class="form-control" :class="{'is-invalid':NoLugarCedu}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="modal-dialog modal-primary modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" v-if="tipoAccionOcupa==2" class="btn btn-primary" @click="registrarOcupa()">Guardar</button>
                                ...
                                <template v-if="tipoAccionBeneficiario==1">
                                    ...
                                    <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                        ...
                                        <tbody class="table table-bordered table-striped mb-0">
                                            ...
                                            <td>
                                                <span v-if="editIndex !== index">{{ index.fecha_afilia  }}</span>
                                                <span v-if="editIndex === index">
                                                <input type="date" class="form-control form-control-sm" v-model="index.fecha_afilia" >
                                                </span>
                                            </td>
                                            <td>
                                                <span v-if="editIndex !== index">{{ index.fecha_muere!=null&&index.fecha_muere!=''&&index.fecha_muere!='0000-00-00' ? 'No / '.index.fecha_muere  : 'Si'  }}</span>
                                                <span v-if="editIndex === index">
                                                <input type="date" class="form-control form-control-sm" v-model="index.fecha_muere" >
                                                </span>
                                            </td>
                                            <td>
                                                <span v-if="editIndex !== index">
                                ...
                                <template v-if="tipoAccionBeneficiario==2">
                                    ...
                                    <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                        ...
                                        <tbody class="table table-bordered table-striped mb-0">
                                            ...
                                            <td>
                                                <span v-if="editIndex2 !== index2">{{ item2.fecha_afilia  }}</span>
                                                <span v-if="editIndex2 === index2">
                                                <input type="date" class="form-control form-control-sm" v-model="item2.fecha_afilia" >
                                                </span>
                                            </td>
                                            <td>
                                                <span v-if="editIndex2 !== index2">{{ item2.fecha_muere!=null&&item2.fecha_muere!=''&&item2.fecha_muere!='null'&&item2.fecha_muere!='0000-00-00' ? 'No / '.item2.fecha_muere  : 'Si'  }}</span>
                                                <span v-if="editIndex2 === index2">
                                                <input type="date" class="form-control form-control-sm" v-model="item2.fecha_muere" >
                                                </span>
                                            </td>
                                            <td>
                                                <span v-if="editIndex2 !== index2">
    ...
    export default {
        ...
        computed:{
            ...
            pagesNumber2: function() {
             ...
             NoContrato: function(){
                return this.campo_obligatorio_form && !this.n_contrato
            },
             NoTel: function(){
                return this.campo_obligatorio_form && !this.tel
            },
             NoCel: function(){
                return this.campo_obligatorio_form && !this.cel
            },
             NoEstado: function(){
                return this.campo_obligatorio_form && !this.estado
            },
             NoFcontra: function(){
                return this.campo_obligatorio_form && !this.fecha_contrato
            },
             NoHcontra: function(){
                return this.campo_obligatorio_form && !this.hora_contrato
            },
             NoBarrio: function(){
                return this.campo_obligatorio_form && !this.barrio
            },
             NoOcupa: function(){
                return this.campo_obligatorio_form && !this.id_ocupacion
            },
             NoReferencia: function(){
                return this.campo_obligatorio_form && !this.referencias
            },
             NoTelReferencia: function(){
                return this.campo_obligatorio_form && !this.tel_referencia
            },
             NoValorMensual: function(){
                return this.campo_obligatorio_form && !this.vr_mensual
            },
             NoValorSemestre: function(){
                return this.campo_obligatorio_form && !this.vr_semestre
            },
             NoValorAnual: function(){
                return this.campo_obligatorio_form && !this.vr_año
            },
            NoLugarCedu: function(){
                return this.campo_obligatorio_form && !this.lugar_cedula
            },
        },
        ...
        methods : {
             //Funciones formulario dinamico beneficiarios
               add() {
                ...
                this.items.push({ nombre: '', documento: '', tipo_documento: '', parentesco: '', edad: '', fecha_afilia: '', fecha_muere: '' })
            ...
            //Funciones formulario dinamico adicionales
                add2() 
                {
                    ...
                    this.items2.push({ nombre: '', documento: '', tipo_documento: '', parentesco: '', edad: '', fecha_afilia: '', fecha_muere: '' })
            ...
            anularPago(id_borrar){
                let me = this;
                if(confirm('Esta seguro de anular este pago?')){
                    axios.put(this.ruta+'/contratos/anular_pago',{
                        'id_pago' : id_borrar
                    }).then(function (response){
            ...
            validarContrato(){
                ...
                if(this.NoContrato){detener=true;}
                if(this.NoTel){detener=true;}
                if(this.NoCel){detener=true;}
                if(this.NoEstado){detener=true;}
                if(this.NoFcontra){detener=true;}
                if(this.NoHcontra){detener=true;}
                if(this.NoBarrio){detener=true;}
                if(this.NoOcupa){detener=true;}
                if(this.NoReferencia){detener=true;}
                if(this.NoTelReferencia){detener=true;}
                if(this.NoValorMensual){detener=true;}
                if(this.NoValorSemestre){detener=true;}
                if(this.NoValorAnual){detener=true;}
                if(this.NoLugarCedu){detener=true;}
                return detener;
            },   
            /*validarContrato(){
                let me = this;
                    ...
                    case "contrato":
                    {
                        switch(accion){
                            ...
                            case 'beneficiarios':
                            {
                                ...
                                this.fecha_afilia=data['fecha_afilia'];
                                this.fecha_muere=data['fecha_muere'];
                            ...
                            case 'adicionales':
                            {
                                ...
                                this.parentesco=data['parentesco'];
                                this.fecha_nacimiento=data['fecha_nacimiento'];
                                this.fecha_nacimiento=data['fecha_afilia'];
                                this.fecha_nacimiento=data['fecha_muere'];
