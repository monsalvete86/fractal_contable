        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <button style="float: left;" type="button" @click="mostrarDetalle()"  v-bind:class="[tipo_formato_new ? 'btn btn-primary mr-2 mt-2' : 'btn btn-secondary mr-2 mt-1']" >
                        <i class="icon-plus"></i>&nbsp;Nuevo
                    </button>
                    <label class="mt-1 mr-2" style="float: left;" for="text-input">Tipo Formato</label>
                                ...
                                <tbody>
                                    <tr v-for="registro in arrayRegistros" :key="registro.id">
                                        ...
                                        <td style="width:178px !important">                                          
                                            ...
                                            <template v-if="registro.condicion ==1 && registro.cerrado==1">
                                                <button type="button" @click="reabrirFormato(registro.id)" class="btn btn-secondary  btn-sm" title='Ver formato'>
                                                    <i class="icon-lock"></i>
                                                </button>
                                            </template>
                                        </td>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td v-text="detalle.aux_nom_ter"></td>
...
export default {
    ...
    methods : {
        ...
        reabrirFormato(id_formato){
            swal({
                title: 'Esta seguro de reabrir este formato?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta +'/formatos/reabrir',{
                        'id': id_formato,
                    }).then(function (response) {
                        me.listarRegistros(1);
                        swal(
                        'Cerrado!',
                        'El formato ha sido reabierto con éxito.',
                        'success'
                        )
                    }).catch(function (error) {
                        console.log(error);
