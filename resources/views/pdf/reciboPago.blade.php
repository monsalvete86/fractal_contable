...
<html>
    ...
    <body style="    max-width: 250px;">
        ...
        <br>             
        <b>Recibo No.</b> {{$recibo_caja->numero}}<br>
        <b>Fecha:    </b> {{$recibo_caja->fecha}}<br><br>
        <b>Cliente:</b>        
...
<?php   if($pago->observacion!=''){?>
           <br><br> <b>Observación:</b><br>
           {{$pago->observacion}}<br>
<?php   }?>
        
        
        <br>
        <b>Subtotal:</b> $ {{number_format($pago->valor_pago,0)}}<br>
        <b>Impuestos:</b> $0<br>
        <b>Total:</b>$ {{number_format($pago->valor_pago,0)}}<br><br>
        <div     style="text-align: center;">
