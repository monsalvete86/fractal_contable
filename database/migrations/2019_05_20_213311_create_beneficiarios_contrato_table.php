...
class CreateBeneficiariosContratoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('beneficiarios_contrato', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('beneficiarios_contrato');
    }
}
